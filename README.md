...
* GPU Architecture (Compute Capability)
   ...
   * Returns feature list in the form of `intel::gt_gmdid::<gt_gmdid>`
   * Each value (`<gt_gmdid>`) in the list represents human readable form of
     Intel hardware GT GMDID quariable via Level Zero [ZE_extension_device_ip_version]
...
## Understanding Intel GT GMDID Values

GT GMDID is an identifier assigned to differentiate architectures of compute
...
the list can be set as GT GMDID or via acronym name internally mapped to the
respective GT GMDID. To query GT GMDID(s) for the specific acronym
