...
# architectures can be identified. In general "Device IP Version" is defined by
# particular driver implementation. For Intel GPUs it resolves to GT GMDID values.
#
